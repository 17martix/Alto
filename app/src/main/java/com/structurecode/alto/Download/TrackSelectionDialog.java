...
public class TrackSelectionDialog extends DialogFragment {
     ...
     * specified in its current state.
     */
    ...
    /**
     * Creates a dialog for a given , whose parameters will be
    ...
    /**
     * Creates a dialog for given
     *
     * @param titleId The resource id of the dialog title.
     * @param mappedTrackInfo The  to display.
     * @param initialParameters The  describing the initial
     *     track selection.
     * @param allowAdaptiveSelections Whether adaptive selections (consisting of more than one track)
     *     can be made.
     * @param allowMultipleOverrides Whether tracks from multiple track groups can be selected.
     * @param onClickListener  called when tracks are selected.
     * @param onDismissListener  called when the dialog is
     *     dismissed.
     */
